...
export const querySchemaRealTime: FormSchemaGetter = () => [
  {    component: 'Input',    fieldName: 'sn',    label: '设备SN',    width: 200,  },
  {    component: 'Select',    componentProps: {      options: getDictOptions('dev_stat'),    },    fieldName: 'devStat',    label: '状态',  },
  {    component: 'Select',    componentProps: {      options: getDictOptions('valvedata_sorttype'),    },    fieldName: 'devSortType',    label: '数据排序',  },
];
...
export const drawerSchema1: FormSchemaGetter = () => [
  ...
  {    label: '指令编码1',    fieldName: 'cmdcode',    component: 'Select',    componentProps: {      options: getDictOptions('dev_fm_cmd_code'),    },    rules: 'selectRequired',    defaultValue:'31',  },
...
export const drawerSchema2: FormSchemaGetter = () => [
  {    fieldName: 'sn',    component: 'hidden',    defaultValue:'',  },
  {    label: '指令编码2',    fieldName: 'cmdcode',    component: 'Select',    componentProps: {      options: getDictOptions('dev_rb_cmd_code'),    },    rules: 'selectRequired',    defaultValue:'31',  },
  {    label: '读写标识',    fieldName: 'type',    component: 'Select',    componentProps: {      options: getDictOptions('cmdtype'),    },    rules: 'selectRequired',    defaultValue:'00',  },
  {    label: '指令参数',    fieldName: 'cmdparams',    component: 'Input',    defaultValue:'',  },
]
...
export const drawerSchema3: FormSchemaGetter = () => [
  {    fieldName: 'sn',    component: 'hidden',    defaultValue:'',  },
  {    label: '指令编码3',    fieldName: 'cmdcode',    component: 'Select',    componentProps: {      options: getDictOptions('dev_gw_cmd_code'),    },    rules: 'selectRequired',    defaultValue:'16',  },
  {    label: '读写标识',    fieldName: 'type',    component: 'Select',    componentProps: {      options: getDictOptions('cmdtype'),    },    rules: 'selectRequired',    defaultValue:'00',  },
  {    label: '指令参数',    fieldName: 'cmdparams',    component: 'Input',    defaultValue:'',  },
]
...
export const drawerSchema4: FormSchemaGetter = () => [
  {    fieldName: 'sn',    component: 'hidden',    defaultValue:'',  },
  {    label: '指令编码4',    fieldName: 'cmdcode',    component: 'Select',    componentProps: {      options: getDictOptions('dev_sw_cmd_code'),    },    rules: 'selectRequired',    defaultValue:'31',  },
  {    label: '读写标识',    fieldName: 'type',    component: 'Select',    componentProps: {      options: getDictOptions('cmdtype'),    },    rules: 'selectRequired',    defaultValue:'00',  },
  {    label: '指令参数',    fieldName: 'cmdparams',    component: 'Input',    defaultValue:'',  },
]
...
export const drawerSchema5: FormSchemaGetter = () => [
  {    fieldName: 'sn',    component: 'hidden',    defaultValue:'',  },
  {    label: '指令编码5',    fieldName: 'cmdcode',    component: 'Select',    componentProps: {      options: getDictOptions('dev_yl_cmd_code'),    },    rules: 'selectRequired',    defaultValue:'16',  },
  {    label: '读写标识',    fieldName: 'type',    component: 'Select',    componentProps: {      options: getDictOptions('cmdtype'),    },    rules: 'selectRequired',    defaultValue:'00',  },
  {    label: '指令参数',    fieldName: 'cmdparams',    component: 'Input',    defaultValue:'',  },
]
...
export const drawerSchema6: FormSchemaGetter = () => [
  {    fieldName: 'sn',    component: 'hidden',    defaultValue:'',  },
  {    label: '指令编码',    fieldName: 'cmdcode',    component: 'Select',    componentProps: {      options: getDictOptions('dev_zf_cmd_code'),    },    rules: 'selectRequired',    defaultValue:'63AA',  },
  {    label: '读写标识',    fieldName: 'type',    component: 'Select',    componentProps: {      options: getDictOptions('cmdtype'),    },    rules: 'selectRequired',    defaultValue:'00',  },
  {    label: '指令参数',    fieldName: 'cmdparams',    component: 'Input',    defaultValue:'',  },
]
